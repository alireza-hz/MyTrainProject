...
namespace DataLayer.Migrations
{
    ...
    [Migration("20240406142108_createtbls")]
            ...
            modelBuilder.Entity("Domain.Products.Category", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            MyCategoryID = 1,
                            Createdate = new DateTime(2024, 4, 6, 17, 51, 8, 775, DateTimeKind.Local).AddTicks(9356),
                            Isdelete = false,
                            ModifiedDate = new DateTime(2024, 4, 6, 17, 51, 8, 775, DateTimeKind.Local).AddTicks(9356),
                            description = "گرافیک"
                        },
                        new
                        {
                            MyCategoryID = 2,
                            Createdate = new DateTime(2024, 4, 6, 17, 51, 8, 775, DateTimeKind.Local).AddTicks(9358),
                            Isdelete = false,
                            ModifiedDate = new DateTime(2024, 4, 6, 17, 51, 8, 775, DateTimeKind.Local).AddTicks(9358),
                            description = "برنامه نویسی"
                        },
                        new
                        {
                            MyCategoryID = 3,
                            Createdate = new DateTime(2024, 4, 6, 17, 51, 8, 775, DateTimeKind.Local).AddTicks(9360),
                            Isdelete = false,
                            ModifiedDate = new DateTime(2024, 4, 6, 17, 51, 8, 775, DateTimeKind.Local).AddTicks(9360),
                            description = "شبکه"
                        },
                        new
                        {
                            MyCategoryID = 4,
                            Createdate = new DateTime(2024, 4, 6, 17, 51, 8, 775, DateTimeKind.Local).AddTicks(9361),
                            Isdelete = false,
                            ModifiedDate = new DateTime(2024, 4, 6, 17, 51, 8, 775, DateTimeKind.Local).AddTicks(9361),
            ...
            modelBuilder.Entity("Domain.Users.MyRole", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            MyRoleID = 1,
                            CreateDate = new DateTime(2024, 4, 6, 17, 51, 8, 775, DateTimeKind.Local).AddTicks(9246),
                            IsDelete = false,
                            ModifiedDate = new DateTime(2024, 4, 6, 17, 51, 8, 775, DateTimeKind.Local).AddTicks(9258),
                            RoleName = "user",
                            RoleTitle = "کاربر"
                        },
                        new
                        {
                            MyRoleID = 2,
                            CreateDate = new DateTime(2024, 4, 6, 17, 51, 8, 775, DateTimeKind.Local).AddTicks(9260),
                            IsDelete = false,
                            ModifiedDate = new DateTime(2024, 4, 6, 17, 51, 8, 775, DateTimeKind.Local).AddTicks(9260),
                            RoleName = "Admin",
            ...
            modelBuilder.Entity("Domain.Users.MyUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            MYUserID = 1,
                            Avatar = "download.png",
                            CreateDate = new DateTime(2024, 4, 6, 17, 51, 8, 775, DateTimeKind.Local).AddTicks(9384),
                            IsDelete = false,
                            Mobile = "9199149932",
                            ModifiedDate = new DateTime(2024, 4, 6, 17, 51, 8, 775, DateTimeKind.Local).AddTicks(9384),
                            MyRoleID = 2,
                            UserName = "ادمین"
                        });
                });

            modelBuilder.Entity("Domain.Users.Visit", b =>
                {
